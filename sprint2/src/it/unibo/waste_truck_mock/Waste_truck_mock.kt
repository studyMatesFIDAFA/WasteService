		...
		return { //this:ActionBasciFsm
				...
				state("indoor_request") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t052",targetState="accepted",cond=whenReply("loadaccept"))
					transition(edgeName="t053",targetState="altrarichiesta",cond=whenReply("loadrejected"))
				}	 
				...
				state("altrarichiesta") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t154",targetState="fine",cond=whenReply("loadaccept"))
					transition(edgeName="t155",targetState="rejected",cond=whenReply("loadrejected"))
				}	 
