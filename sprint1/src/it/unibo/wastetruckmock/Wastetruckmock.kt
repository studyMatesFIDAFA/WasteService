		...
		return { //this:ActionBasciFsm
				...
				state("camion_req") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="camion_accepted",cond=whenReply("loadaccept"))
					transition(edgeName="t012",targetState="camion_rejected",cond=whenReply("loadrejected"))
				}	 
