		...
		return { //this:ActionBasciFsm
				...
				state("indoor_request") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t019",targetState="accepted",cond=whenReply("loadaccept"))
					transition(edgeName="t020",targetState="altrarichiesta",cond=whenReply("loadrejected"))
				}	 
				...
				state("altrarichiesta") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t121",targetState="fine",cond=whenReply("loadaccept"))
					transition(edgeName="t122",targetState="rejected",cond=whenReply("loadrejected"))
				}	 
