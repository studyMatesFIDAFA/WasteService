		...
		return { //this:ActionBasciFsm
				...
				state("camion_req") { //this:State
					action { //it:State
						...
						request("load_req", "load_req($Tipo_carico,$Peso_carico)" ,"wasteservice" )  
					}
					 transition(edgeName="t013",targetState="camion_accepted",cond=whenReply("loadaccept"))
					transition(edgeName="t014",targetState="camion_rejected",cond=whenReply("loadrejected"))
				}	 
