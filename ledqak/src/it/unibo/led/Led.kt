		...
		return { //this:ActionBasciFsm
				...
				state("wait_cmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="esegui_cmd",cond=whenDispatch("cmd"))
				}	 
				...
				state("blink") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t11",targetState="blink",cond=whenTimeout("local_tout_led_blink"))   
					transition(edgeName="t12",targetState="esegui_cmd",cond=whenDispatch("cmd"))
				}	 
			}
		}
}
